---
name: design-lore-psychology
description: >
  Deep UX psychology knowledge base for theoretical design analysis. Covers
  Russian Activity Theory (Vygotsky ZPD, Leontiev, Luria, Bakhtin, Engeström),
  Jungian depth psychology (12 archetypes, Shadow, collective unconscious),
  phenomenology (Husserl, Heidegger ready-to-hand, Merleau-Ponty embodiment,
  Don Ihde technology relations), semiotics (Peirce, Saussure, Barthes),
  psychoanalytic UX (Freud, Lacan mirror stage, Winnicott transitional objects),
  ecological psychology (Gibson affordances), flow and motivation
  (Csikszentmihalyi, Deci & Ryan SDT, Maslow), existential design (Sartre,
  Kierkegaard choice anxiety), narrative psychology (Campbell Hero's Journey,
  Propp, Bateson), and persuasion theory (Lefebvre reflexive control, Pavlov,
  Bernays, Cialdini, Sun Tzu, ethics spectrum). Trigger for deep UX analysis,
  psychology, archetypes, phenomenology, semiotics, persuasion, or theory-led
  design audits.
---

# Design Lore — Psychology

Advanced UX psychology module for deep theoretical analysis. Use when the user
requests psychological frameworks, theory-led audits, archetype analysis,
persuasion evaluation, or asks about specific theorists.

> **Part of the Design Lore family.** This module provides the theoretical
> depth layer. For core Figma and design knowledge, use **design-lore**.
...
**"Shadow / dark patterns / unconscious"** → lore/22-deep-ux-psychology.jsonl (dp-008)
...
- **Theory is a lens, not a prescription**: Use psychological frameworks to analyse and illuminate, not to dictate.
- **The Shadow is real**: Every product has unconscious effects on users — acknowledge and design for them.
- **Invisible is the goal**: The best interfaces disappear (Heidegger's ready-to-hand). When users notice the tool, something broke.
